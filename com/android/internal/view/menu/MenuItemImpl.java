...
public final class MenuItemImpl implements MenuItem {
    ...
    private String mTitleCondensed;
    ...
    private /*WeakReference<ItemView>*/ ItemView mItemViews[]; 
    ...
    MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering,
        ...
        // XXX mItemViews = new WeakReference[MenuBuilder.NUM_TYPES];
        
        mItemViews = new ItemView[MenuBuilder.NUM_TYPES];
    ...
    public MenuItem setEnabled(boolean enabled) {
        ...
        for (int i = MenuBuilder.NUM_TYPES - 1; i >= 0; i--) {
            ...
            if (hasItemView(i)) {
            	...
            	//xxx mItemViews[i].get().setEnabled(enabled);
            }
        }
    ...
    */
    ...
    public MenuItem setAlphabeticShortcut(char alphaChar) {
        ...
        // XXX refreshShortcutOnItemViews();
    ...
    String getShortcutLabel() {
        ...
        StringBuffer sb = new StringBuffer(sPrependShortcutLabel);
        switch (shortcut) {
    ...
    */
    ...
    String getTitleForItemView(MenuView.ItemView itemView) {
    ...
    public MenuItem setTitle(int title) {
    	...
    	return setTitle(Resources.getSystem().getString(title));
    	
    	// XXX return setTitle(mMenu.getContext().getString(title));
    }
    ...
    public MenuItem setTitleCondensed(String title) {
        ...
        for (int i = MenuBuilder.NUM_TYPES - 1; i >= 0; i--) {
            // Refresh those item views that prefer a condensed title
             ...
             //}
                ...
                if (hasItemView(i) && (mItemViews[i].prefersCondensedTitle())) {
    ...
    public MenuItem setIcon(int iconResId) {
        ...
        if (haveAnyOpenedIconCapableItemViews()) {
           // XXX
           // Drawable drawable = iconResId != NO_ICON ? mMenu.getResources().getDrawable(iconResId) : null;
    ...
    boolean setVisibleInt(boolean shown) {
        ...
        if (oldFlags != mFlags) {
            ...
            for (int i = MenuBuilder.NUM_TYPES - 1; i >= 0; i--) {
                if (hasItemView(i)) {
                	((View) mItemViews[i]).setVisibility(visibility);
   ...
   public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener clickListener) {
    ...
    public View getItemView(int menuType, ViewGroup parent) {
        ...
        */
        ...
        return (View) mItemViews[menuType];
    }
    ...
    private MenuView.ItemView createItemView(int menuType, ViewGroup parent) {
    	...
    	MidpMenuItemView itemView = null;
       
 
    	switch(menuType) {
    	
        case MenuBuilder.TYPE_MIDP_SYSTEM:
        	if(mGroup == Menu.CATEGORY_SYSTEM) itemView = new MidpMenuItemView();
        	break;
        	
        case MenuBuilder.TYPE_MIDP_OTHERS:
        	if(mGroup != Menu.CATEGORY_SYSTEM) itemView = new MidpMenuItemView();
        	break;
        	
        case MenuBuilder.TYPE_EXPANDED:
        	itemView = new MidpMenuItemView();
        	break;	
