...
public class FocusFinder {
	...
	private final static String TAG="FocusFinder";
	

	 private static FocusFinder tlFocusFinder = new FocusFinder();
    ...
    private View findNextFocus(ViewGroup root, View focused, Rect focusedRect, int direction) {
    	...
    	Vector focusables = root.getFocusables(direction);
        ...
        for (int i = 0; i < numFocusables; i++) {
            View focusable = (View) focusables.elementAt(i);
    ...
    public View findNearestTouchable(ViewGroup root, int x, int y, int direction, int[] deltas) {
        ...
        int edgeSlop = 10; // XXX ViewConfiguration.getEdgeSlop();
        
        Rect closestBounds = new Rect();
        Rect touchableBounds = mOtherRect;
        
        for (int i = 0; i < numTouchables; i++) {
            View touchable = (View) touchables.elementAt(i);
