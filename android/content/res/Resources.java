...
public class Resources {
    ...
    // Use the current SDK version code.  If we are a development build,  also allow the previous SDK version + 1.
    //private static final int sSdkVersion = 001;
    ...
    /*package*/ final Object/*TypedValue*/ mTmpValue = new Object();
    ...
    private Hashtable/*<Drawable.ConstantState>*/ mDrawableCache = new Hashtable();
    
    private Hashtable/*<Drawable.ConstantState>*/ mBitmapCache = new Hashtable();
...
*/
    ...
    /*package*/ Drawable loadDrawable(int id) throws NotFoundException {
        ...
        Drawable dr = getCachedDrawable(new Integer(id));
        ...
        if (dr != null) {
            ...
            if (cs != null) {
                if (mPreloading) {
                    ...
                    synchronized (mTmpValue) {
                        //Log.i(TAG, "Saving cached drawable @ #" + Integer.toHexString(key.intValue())
                        //        + " in " + this + ": " + cs);
    ...
    private Drawable getCachedDrawable(Integer key) {
        synchronized (mTmpValue) {
            WeakReference wr = (WeakReference) mDrawableCache.get(key);
    ...
    public Bitmap getBitmap(int id) {
    	...
    	Bitmap bmp = (Bitmap) mBitmapCache.get(Id);
    ...
    private Bitmap loadBitmap(int id) {
    	...
    	return BitmapFactory.decodeResource("/flow/"+name);
    ...
    private String getResourceName(int id) {
    	...
    	case R.drawable.drawable_checkbox_checked:
    		return "checkbox_checked.png";

    	case R.drawable.drawable_checkbox_unchecked:
    		return "checkbox_unchecked.png";
    		
    	case R.drawable.drawable_checkbox_disabled:
    		return "checkbox_disabled.png";
    		
    	case R.drawable.drawable_radio_button_checked:
    		return "radio_button_checked.png";
    		
    	case R.drawable.drawable_radio_button_unchecked:
    		return "radio_button_unchecked.png";
    		
    		
    	case R.drawable.drawable_spinner_pressed:
    		return "spinner.png";	
    		
    	case R.drawable.drawable_spinner_released:
    		return "spinner.png";	
