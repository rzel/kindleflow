	...
	*/
    ...
    public ProgressBar(/*Context context, AttributeSet attrs, int defStyle*/) {
        ...
        */
    	...
    	ShapeDrawable drawable = new ShapeDrawable(new RoundRectShape(5,5));
    	drawable.getPaint().setStyle(Paint.FILL);
    ...
    private Drawable tileify(Drawable drawable, boolean clip) {
        ...
        if (drawable instanceof LayerDrawable) {
            ...
            final Drawable shapeDrawable = new ShapeDrawable(getDrawableShape());
    ...
    */
    ...
    synchronized void setProgress(int progress, boolean fromUser) {
        ...
        if (progress != mProgress) {
            mProgress = progress;
            // XXX refreshProgress(R.id.progress, mProgress, fromUser);
        }
    }
    ...
    public synchronized void setSecondaryProgress(int secondaryProgress) {
        ...
        if (secondaryProgress != mSecondaryProgress) {
            ...
            // XXX refreshProgress(R.id.secondaryProgress, mSecondaryProgress, false);
        }
    }
    ...
    public synchronized void setMax(int max) {
        ...
        if (max != mMax) {
            ...
            if (mProgress > max) {
                mProgress = max;
                // XXX refreshProgress(R.id.progress, mProgress, false);
            }
        }
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (d != null) {
            ...
            if (mAnimation != null) {
                ...
                if (System.currentTimeMillis() - mLastDrawTime >= ANIMATION_RESOLUTION) {
            ...
            */
            ...
            float scale = mMax > 0 ? (float) mProgress / (float) mMax : 0;
             ...
             mProgressPaint.setStyle(Paint.FILL);
             mProgressPaint.setColor(Color.LIGHTGREY);
             mProgressRect.set(d.getBounds());
             mProgressRect.left += 5;
             mProgressRect.top += 2;
             mProgressRect.bottom -=2;
             mProgressRect.right = mProgressRect.left + (int)((mProgressRect.right-mProgressRect.left)*scale) - 5; 

             //canvas.drawRect(mProgressRect, mProgressPaint);
            
             canvas.drawRoundRect(mProgressRect, 5, 5, mProgressPaint);
