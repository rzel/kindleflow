...
public final class Bitmap {
    ...
    */
    public Bitmap(Image nativeBitmap, boolean isMutable, byte[] ninePatchChunk) {
        if (nativeBitmap == null) {
            throw new RuntimeException("internal error: native bitmap is null");
        }
    ...
    *//** Returns the bitmap's width */
    public final int getWidth() {
        return mWidth == -1 ? mWidth = mNativeBitmap.getWidth(null) : mWidth;
    }

    /** Returns the bitmap's height */
    public final int getHeight() {
        return mHeight == -1 ? mHeight = mNativeBitmap.getHeight(null) : mHeight;
    }
